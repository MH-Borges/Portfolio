...
function corMenu(){
    document.querySelectorAll('.menu').style.backgroundColor = "rgb(0, 0, 0)"; 
}
/*transparencia menu*/

/* skill animation */
document.getElementById("blockinfos").onmouseover = function() {mouseOver()};
...
/*efeito3d*/
VanillaTilt.init(document.querySelectorAll(".imgST"), {
    max: 30,
    speed: 600
});
/*efeito3d*/
